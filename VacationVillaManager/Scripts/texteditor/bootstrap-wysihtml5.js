!function($, wysi) {
        ...
        "emphasis": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                ...
                "<a class='btn" + size + "' data-wysihtml5-command='strikethrough' title='Strikethrough' tabindex='-1'><i class='icon-strikethrough'></i></a>" +
              "</div>" +
            "</li>";
        },
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["../Scripts/texteditor/wysiwyg-color.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
