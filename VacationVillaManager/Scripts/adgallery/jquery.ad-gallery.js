...
(function($) {
  $.fn.adGallery = function(options) {
    var defaults = { loader_image: './../../Scripts/adgallery/loader.gif',
                     start_at_index: 0,
  ...
  AdGallerySlideshow.prototype = {
    ...
    _next: function() {
      ...
      this.countdown.show().find('.bar').attr('style', 'width: 0%;');
      var slide_timer = 0;
      this.countdown_interval = setInterval(
        function() {
          ...
          var percent = slide_timer / context.settings.speed * 100;
          if (percent <= 100) {
              context.countdown.find('.bar').attr('style', 'width: ' + percent + '%;');
          }
        },
        1000
      );
